...
var PeliasGeoCoder = function (options) {
	...
	me.callPelias = function (endpoint, parameters, cb) {
	...
	me.search = function (parameters, cb) {
		me.callPelias(me.url + '/search', parameters, cb);
	};

	me.autocomplete = function (parameters, cb) {
		me.callPelias(me.url + '/autocomplete', parameters, cb);
	};
